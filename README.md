...
## Схема логики конвейера (2 субконвейера + преобразователь):
**Начало-Взятие** (взятие данных из исходного файла, формирование блоков и запись в субконвейер считанных блоков).
**Центр-Преобразование** (чтение блоков из субконвейера считанных блоков, преобразование и запись в субконвейер блоков для сохранения).
